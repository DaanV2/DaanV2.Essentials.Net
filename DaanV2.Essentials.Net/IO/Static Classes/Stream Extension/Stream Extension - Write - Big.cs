...
namespace DaanV2.IO {
    public static partial class StreamExtension {
        ...
        public static void BigEndian_Write(this Stream stream, Int16 Value) {
        ...
        /// <param name="stream">The stream to write to</param>
        /// <param name="Value">The value to write to stream</param>
        public static void BigEndian_Write(this Stream stream, Int32 Value) {
            Byte[] Data = Binary.BitConverter.BigEndian.ToBytes(Value);
            stream.Write(Data, 0, Data.Length);
        }
        ...
        /// <param name="stream">The stream to write to</param>
        /// <param name="Value">The value to write to stream</param>
        public static void BigEndian_Write(this Stream stream, Int64 Value) {
            Byte[] Data = Binary.BitConverter.BigEndian.ToBytes(Value);
            stream.Write(Data, 0, Data.Length);
        }
        ...
        /// <param name="stream">The stream to write to</param>
        /// <param name="Value">The value to write to stream</param>
        public static void BigEndian_Write(this Stream stream, UInt16 Value) {
            Byte[] Data = Binary.BitConverter.BigEndian.ToBytes(Value);
            stream.Write(Data, 0, Data.Length);
        }
        ...
        /// <param name="stream">The stream to write to</param>
        /// <param name="Value">The value to write to stream</param>
        public static void BigEndian_Write(this Stream stream, UInt32 Value) {
            Byte[] Data = Binary.BitConverter.BigEndian.ToBytes(Value);
            stream.Write(Data, 0, Data.Length);
        }
        ...
        /// <param name="stream">The stream to write to</param>
        /// <param name="Value">The value to write to stream</param>
        public static void BigEndian_Write(this Stream stream, UInt64 Value) {
            Byte[] Data = Binary.BitConverter.BigEndian.ToBytes(Value);
            stream.Write(Data, 0, Data.Length);
        }
    }
