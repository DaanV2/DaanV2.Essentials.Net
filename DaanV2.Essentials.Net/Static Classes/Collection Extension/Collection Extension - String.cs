...
namespace DaanV2 {
    public static partial class CollectionExtension {
        ...
        public static List<String> Copy([NotNull] this List<String> values) {
        ...
        public static String[] Copy([NotNull] this String[] values) {
        ...
        public static void Replace([NotNull] this String[] Values, String Old, String New) {
            Int32 Max = Values.Length;
        ...
        /// <param name="Old">The value to replace.</param>
        /// <param name="New">The value to add into.</param>
        public static void Replace([NotNull] this IList<String> Values, String Old, String New) {
            Int32 Max = Values.Count;
